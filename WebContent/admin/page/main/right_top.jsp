...
<script language="javascript" src="/MyFirstItem/js/jquery-1.7.2.js"></script>
...
<body>
	<div id="right_top">
		...
		<div id="loginout">
			...
			<span class="logintext" onclick="window.parent.location.href='${sessionScope.path}/loginServlet?method=logout'">退出系统</span>
		</div>
	</div>
