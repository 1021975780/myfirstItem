...
<body>
	...
	<div class="searchdiv">
		<div>
			文件名称：<input id="name" type="text" value="" />
		</div>
	...
	<table class="table">
		<tr>
			<th style="width: 50px;"><div class="del_t" title="删除"></div> <a
				href="#">反选</a></th>
		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<tr>
						<tr>
							<td colspan="6" valign="middle" style="background: #F6F6F6"><div
									id="jpage" class="jpage"></div></td>
						</tr>
	</table>
